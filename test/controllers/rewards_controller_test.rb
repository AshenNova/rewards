...
class RewardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post rewards_url, params: { reward: { price: @reward.price, reward: @reward.reward, status: @reward.status, value: @reward.value } }
    end
  ...
  test "should update reward" do
    patch reward_url(@reward), params: { reward: { price: @reward.price, reward: @reward.reward, status: @reward.status, value: @reward.value } }
